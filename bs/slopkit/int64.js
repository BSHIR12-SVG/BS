...
function int64(low, hi) {
    // التحقق من وجود الكائن للتأكد من استدعاء الدالة كـ Constructor عبر كلمة (new)
...
// تأمين الحقن في البيئة الكونية للمتصفحات القديمة والحديثة معاً لضمان عدم التعليق
